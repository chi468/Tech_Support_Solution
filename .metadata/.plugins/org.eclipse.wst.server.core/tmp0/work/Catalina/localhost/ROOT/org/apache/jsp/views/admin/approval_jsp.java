 ...
 * Generated at: 2020-03-23 06:50:39 UTC
...
public final class approval_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <li class=\"breadcrumb-item active\">Approval       </li>\r\n");
      out.write("          </ul>\r\n");
      out.write("        </div>\r\n");
      out.write("      </div>\r\n");
      out.write("      <section>\r\n");
      ...
      out.write("          <header> \r\n");
      out.write("            <h1 class=\"h3 display\">회원가입 승인           </h1>\r\n");
      out.write("          </header>\r\n");
      out.write("          <div class=\"row\">\r\n");
      out.write("            <div class=\"col-lg-6\">\r\n");
      out.write("              <div class=\"card\">\r\n");
      out.write("                <div class=\"card-header\">\r\n");
      out.write("                  <h4>가입 신청 리스트</h4>\r\n");
      out.write("                </div>\r\n");
      ...
      out.write("                          <th>가입 신청일</th>\r\n");
      out.write("                          <th></th>\t\r\n");
      out.write("                        </tr>\r\n");
      out.write("                      </thead>\r\n");
      out.write("                      <tbody id=\"admitTbody\">\r\n");
      out.write("                      </tbody>\r\n");
      out.write("                    </table>\r\n");
      out.write("                  </div>\r\n");
      out.write("                </div>\r\n");
      ...
      out.write("              <div class=\"card\">\r\n");
      out.write("                <div class=\"card-header\">\r\n");
      out.write("                  <h4>기술지원 게시판(미지정 리스트)</h4>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"card-body\">\r\n");
      out.write("                  <div class=\"table-responsive\">\r\n");
      ...
      out.write("                        </tr>\r\n");
      out.write("                      </thead>\r\n");
      out.write("                      <tbody id=\"refuseTbody\">                        \r\n");
      out.write("                      </tbody>\r\n");
      out.write("                    </table>\r\n");
      out.write("                  </div>\r\n");
      out.write("                </div>\r\n");
      ...
      out.write("                        </tr>\r\n");
      out.write("                      </thead>\r\n");
      out.write("                      <tbody id=\"admitSuccessTbody\">                       \r\n");
      out.write("                      </tbody>\r\n");
      out.write("                    </table>\r\n");
      out.write("                  </div>\r\n");
      out.write("                </div>\r\n");
      ...
      out.write(" \t\t$.ajax({\r\n");
      out.write(" \t\t\ttype : 'post', \r\n");
      out.write(" \t\t\turl : '/approvalList.do',\r\n");
      out.write(" \t\t\tdata : { state : \"W\" },\r\n");
      out.write(" \t\t\tsuccess : function(memberList){\r\n");
      out.write(" \t\t\t\t\r\n");
      out.write("           \t\tfor(var i=1;i<=memberList.length;i++){  \r\n");
      out.write("           \t\t\t$(\"#admitTbody\").append(\"<tr>\");\r\n");
      out.write("           \t\t\t$(\"#admitTbody\").append('<th scope=\"row\">'+i+'</th>');\r\n");
      out.write("\t\t\t\t\t\t$(\"#admitTbody\").append('<td>'+memberList[i-1].userName+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#admitTbody\").append('<td>'+memberList[i-1].email+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#admitTbody\").append('<td>'+memberList[i-1].phone+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#admitTbody\").append('<td>'+memberList[i-1].typeNo+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#admitTbody\").append('<td>'+memberList[i-1].company+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#admitTbody\").append('<td>'+memberList[i-1].enrollDate+'</td>');        \t\t\t \r\n");
      out.write("        \t\t\t \t$(\"#admitTbody\").append('<td><button value=\"'+memberList[i-1].email+'\" onclick=\"return admit(this);\" id=\"admit\" class=\"btn btn-xs btn-dark\">승인</button></td>');\r\n");
      out.write("        \t\t\t \t$(\"#admitTbody\").append('<td><button value=\"'+memberList[i-1].email+'\" onclick=\"return refuse(this);\" id=\"refuse\" class=\"btn btn-xs btn-dark\">반려</button></td>');\r\n");
      out.write("        \t\t\t\t$(\"#admitTbody\").append(\"</tr>\");\r\n");
      out.write("        \t\t\t}\t\t\r\n");
      out.write(" \t\t\t},\r\n");
      out.write(" \t\t\terror : function(data){\r\n");
      out.write(" \t\t\t\tconsole.log(\"list : ajax통신에러\");\r\n");
      out.write(" \t\t\t} \t\t\t\r\n");
      out.write(" \t\t});\t\t\r\n");
      out.write(" \t\t\r\n");
      out.write(" \t\t\r\n");
      ...
      out.write(" \t\t\ttype : 'post', \r\n");
      out.write(" \t\t\turl : '/approvalList.do',\r\n");
      out.write(" \t\t\tdata : { state : \"R\" },\r\n");
      out.write(" \t\t\tsuccess : function(memberList){\r\n");
      out.write(" \t\t\t\t\r\n");
      out.write("           \t\tfor(var i=1;i<=memberList.length;i++){  \r\n");
      out.write("           \t\t\t$(\"#refuseTbody\").append(\"<tr>\");\r\n");
      out.write("           \t\t\t$(\"#refuseTbody\").append('<th scope=\"row\">'+i+'</th>');\r\n");
      out.write("\t\t\t\t\t\t$(\"#refuseTbody\").append('<td>'+memberList[i-1].userName+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#refuseTbody\").append('<td>'+memberList[i-1].email+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#refuseTbody\").append('<td>'+memberList[i-1].phone+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#refuseTbody\").append('<td>'+memberList[i-1].typeNo+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#refuseTbody\").append('<td>'+memberList[i-1].company+'</td>');\r\n");
      out.write("        \t\t\t \t$(\"#refuseTbody\").append('<td>'+memberList[i-1].enrollDate+'</td>');        \t\t\t \r\n");
      out.write("        \t\t\t \t$(\"#refuseTbody\").append('<td><button value=\"'+memberList[i-1].email+'\" onclick=\"return admit(this);\" id=\"admit\" class=\"btn btn-xs btn-dark\">승인</button></td>');\r\n");
      out.write("        \t\t\t \t$(\"#refuseTbody\").append('<td><button value=\"'+memberList[i-1].email+'\" onclick=\"return deleteMember(this);\" id=\"deleteBtn\" class=\"btn btn-xs btn-dark\">삭제</button></td>');\r\n");
      out.write("        \t\t\t\t$(\"#refuseTbody\").append(\"</tr>\");\r\n");
      out.write("        \t\t\t}\t\t\r\n");
      out.write(" \t\t\t},\r\n");
      out.write(" \t\t\terror : function(data){\r\n");
      ...
      out.write(" \t}); \t\t\r\n");
      out.write(" \t\t\r\n");
      out.write(" \t\t function admit(admBtn){  \t\t\t \r\n");
      out.write(" \t\t\tvar email = admBtn.value;  \t\t\t\r\n");
      out.write("\t \t\t$.ajax({\r\n");
      out.write(" \t\t\t\ttype : 'post',\r\n");
      out.write(" \t\t\t\turl : '/registerAdmit.do',\r\n");
      out.write(" \t\t\t\tdata : {email : email}, \t\t\t\t\r\n");
      out.write(" \t\t\t\tsuccess : function(list){\r\n");
      out.write(" \t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t$(\"#admitTbody\").empty();\r\n");
      out.write(" \t\t\t\t\t$(\"#refuseTbody\").empty(); \t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\tvar memberList = list[0];\r\n");
      out.write(" \t \t\t\t\t\r\n");
      out.write(" \t           \t\tfor(var i=1;i<=memberList.length;i++){  \r\n");
      out.write(" \t           \t\t\t\t$(\"#admitTbody\").append(\"<tr>\");\r\n");
      out.write(" \t           \t\t\t\t$(\"#admitTbody\").append('<th scope=\"row\">'+i+'</th>');\r\n");
      ...
      out.write(" \t           \t\t\r\n");
      out.write(" \t           \t\t\r\n");
      out.write(" \t           \t\tvar refuseList = list[1];\r\n");
      out.write(" \t           \t\t\r\n");
      out.write(" \t           \t\tfor(var i=1;i<=refuseList.length;i++){  \r\n");
      out.write("        \t\t\t\t$(\"#refuseTbody\").append(\"<tr>\");\r\n");
      out.write("        \t\t\t\t$(\"#refuseTbody\").append('<th scope=\"row\">'+i+'</th>');\r\n");
      out.write("\t     \t\t\t   \t$(\"#refuseTbody\").append('<td>'+refuseList[i-1].userName+'</td>');\r\n");
      out.write("\t     \t\t\t \t$(\"#refuseTbody\").append('<td>'+refuseList[i-1].email+'</td>');\r\n");
      out.write("\t     \t\t\t \t$(\"#refuseTbody\").append('<td>'+refuseList[i-1].phone+'</td>');\r\n");
      out.write("\t     \t\t\t \t$(\"#refuseTbody\").append('<td>'+refuseList[i-1].typeNo+'</td>');\r\n");
      out.write("\t     \t\t\t \t$(\"#refuseTbody\").append('<td>'+refuseList[i-1].company+'</td>');\r\n");
      out.write("\t     \t\t\t \t$(\"#refuseTbody\").append('<td>'+refuseList[i-1].enrollDate+'</td>');        \t\t\t \r\n");
      out.write("     \t\t\t \t\t$(\"#refuseTbody\").append('<td><button value=\"'+refuseList[i-1].email+'\" onclick=\"return admit(this);\" id=\"admit\" class=\"btn btn-xs btn-dark\">승인</button></td>');\r\n");
      out.write("\t     \t\t\t \t$(\"#refuseTbody\").append('<td><button value=\"'+refuseList[i-1].email+'\" onclick=\"return deleteMember(this);\" id=\"delteBtn\" class=\"btn btn-xs btn-dark\">삭제</button></td>');\r\n");
      out.write("\t     \t\t\t\t$(\"#refuseTbody\").append(\"</tr>\");\r\n");
      out.write("     \t\t\t\t}\r\n");
      out.write(" \t           \t\t\r\n");
      out.write(" \t           \t\tvar admitMember = list[2][0]; \t           \t\t\r\n");
      out.write("\t \t            \r\n");
      out.write("    \t    \t\t$(\"#admitSuccessTbody\").append(\"<tr>\");\r\n");
      out.write("        \t\t\t$(\"#admitSuccessTbody\").append('<th scope=\"row\"></th>');\r\n");
      out.write("   \t\t\t\t   \t$(\"#admitSuccessTbody\").append('<td>'+admitMember.userName+'</td>');\r\n");
      out.write("     \t\t\t \t$(\"#admitSuccessTbody\").append('<td>'+admitMember.email+'</td>');\r\n");
      out.write("   \t \t\t\t \t$(\"#admitSuccessTbody\").append('<td>'+admitMember.phone+'</td>');\r\n");
      out.write("   \t\t\t\t \t$(\"#admitSuccessTbody\").append('<td>'+admitMember.typeNo+'</td>');\r\n");
      out.write("   \t\t\t\t \t$(\"#admitSuccessTbody\").append('<td>'+admitMember.company+'</td>');\r\n");
      out.write("   \t\t\t\t \t$(\"#admitSuccessTbody\").append('<td>'+admitMember.enrollDate+'</td>');        \t\t\t      \t\t\t \t\r\n");
      out.write("   \t\t\t\t\t$(\"#admitSuccessTbody\").append(\"</tr>\");     \t\t\t\t\r\n");
      out.write(" \t \t\t\t},\r\n");
      out.write(" \t \t\t\terror : function(data){\r\n");
      out.write(" \t \t\t\t\tconsole.log(\"list : ajax통신에러\");\r\n");
      ...
      out.write("\t \t\r\n");
      out.write("\t \t\r\n");
      out.write("\t \tfunction refuse(rfsBtn){\r\n");
      out.write("\t \t\t\r\n");
      out.write("\t \t\tvar email = rfsBtn.value;\r\n");
      out.write("\t \t\t\r\n");
      out.write("\t \t\t$.ajax({\r\n");
      out.write(" \t\t\t\ttype : 'post',\r\n");
      out.write(" \t\t\t\turl : '/registerRefuse.do',\r\n");
      out.write(" \t\t\t\tdata : {email : email}, \t\t\t\t\r\n");
      out.write(" \t\t\t\tsuccess : function(list){\r\n");
      out.write(" \t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t$(\"#admitTbody\").empty();\r\n");
      ...
      out.write("\t     \t\t\t \t$(\"#refuseTbody\").append('<td>'+refuseList[i-1].enrollDate+'</td>');        \t\t\t \r\n");
      out.write("     \t\t\t \t\t$(\"#refuseTbody\").append('<td><button value=\"'+refuseList[i-1].email+'\" onclick=\"return admit(this);\" id=\"admit\" class=\"btn btn-xs btn-dark\">승인</button></td>');\r\n");
      out.write("\t     \t\t\t \t$(\"#refuseTbody\").append('<td><button value=\"'+refuseList[i-1].email+'\" onclick=\"return deleteMember(this);\" id=\"deleteBtn\" class=\"btn btn-xs btn-dark\">삭제</button></td>');\r\n");
      out.write("\t     \t\t\t\t$(\"#refuseTbody\").append(\"</tr>\");\r\n");
      out.write("     \t\t\t\t}\r\n");
      out.write(" \t \t\t\t},\r\n");
      out.write(" \t \t\t\terror : function(data){\r\n");
      ...
      out.write("\t \t\r\n");
      out.write("\t \t\r\n");
      out.write("\t\tfunction deleteMember(delBtn){\r\n");
      out.write("\t \t\t\r\n");
      out.write("\t \t\tvar email = delBtn.value;\r\n");
      out.write("\t \t\t\r\n");
      out.write("\t \t\t$.ajax({\r\n");
      out.write(" \t\t\t\ttype : 'post',\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/admin/approval.jsp(10,3) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      _jspx_th_c_005fif_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sessionScope.member.typeNo==4}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());

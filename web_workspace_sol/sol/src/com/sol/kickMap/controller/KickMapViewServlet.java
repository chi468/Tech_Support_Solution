package com.sol.kickMap.controller;
 ...
 */
@WebServlet(name = "KickMapView", urlPatterns = { "/kickMapView.do" })
public class KickMapViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public KickMapViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("views/kickMap/kickMap.jsp");

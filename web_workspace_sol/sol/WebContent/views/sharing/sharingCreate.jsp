          ...
          <div class="row">      
            <div class="col-lg-10">
              <div class="card">
                ...
                <div class="line"></div>                
                <div class="card-body">                
                  <form class="form-horizontal" action="/createSharing.do" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-6 offset-sm-6">
                        ...
                        <a href="/views/sharing/sharing.jsp" onclick="return isCancel();" class="btn btn-secondary">취소</a>                        
                      </div>
                    </div>
                  </form>
                </div>

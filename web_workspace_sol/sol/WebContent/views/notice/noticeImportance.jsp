                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-sm">
                      ...
                      <tbody>
                      	...
                      	<c:forEach var="board" items="${requestScope.pageBoardDataImportance.boardList}" varStatus="status">	
                      		<tr id="importanceBoardList${status.count}">
        	              		...
        	              		<td id="text${status.count}">        	              		
									...
									<script>
										...
										$("#importanceBoardList${status.count}").mouseenter(function(){											
											$(this).css("border","outset");				
										});
										
										$("#importanceBoardList${status.count}").mouseleave(function(){											
											$(this).css("border","none");				
										});
								
										$("#importanceBoardList${status.count}").click(function(){											

  ...
  <body>
          ...
          <div class="row">      
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="line"></div>                
                <div class="card-body">                
                  <form class="form-horizontal" action="/createNotice.do" method="post" enctype="multipart/form-data">                  	
                    ...
                    <c:if test="${sessionScope.member.typeNo gt 2}">
                     <div class="line"></div>
                     <div class="form-group row">
                       <label class="col-sm-2 form-control-label">메인페이지 표시 <br><small class="text-primary">한개의 글만 메인페이지에 등록 가능합니다.</small></label>
                       <div class="col-sm-10">
                         <div class="i-checks">
                           <input id="loginActive" name="loginActive" type="checkbox" value="Y" class="form-control-custom">
	...
	<script>
		...
		$(function(){
			...
			if("${sessionScope.member.typeNo}"<2){
			
				alert("글쓰기 권한이 없습니다.(제조사 직원만 작성이 가능합니다.)");

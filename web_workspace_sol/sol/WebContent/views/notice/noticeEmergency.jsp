                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-sm">
                      ...
                      <tbody>
                      	...
                      	<c:forEach var="board" items="${requestScope.pageBoardDataEmergency.boardList}" varStatus="status">	
                      		<tr id="emergencyBoardList${status.count}">
        	              		...
        	              		<td id="text${status.count}">        	              		
									...
									<script>
										...
										$("#emergencyBoardList${status.count}").mouseenter(function(){											
											$(this).css("border","outset");				
										});
										
										$("#emergencyBoardList${status.count}").mouseleave(function(){											
											$(this).css("border","none");				
										});
								
										$("#emergencyBoardList${status.count}").click(function(){											

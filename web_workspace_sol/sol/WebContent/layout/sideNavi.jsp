      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center"><img src="/img/photos/externalFile.jpg" alt="person" class="img-fluid rounded-circle">
          	<h3><span>${member.company }</span></h3>
            <h2 class="h5">${member.userName}</h2><span>${member.email}</span>
          </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li><a href="/mainNotice.do"> <i class="icon-home"></i>Home                             </a></li>
            ...
            <li><a href="#boardDropDown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Board</a>
              <ul id="boardDropDown" class="collapse list-unstyled ">
                ...
                <li><a href="/kickMapView.do">킥보드 Map</a></li>
              </ul>
            </li>
          </ul>
        </div>
       	...
       	<c:if test="${sessionScope.member.typeNo==4}">       	       
        	...
        	<h5 class="sidenav-heading">Admin menu</h5>
          	...
          	<div class="badge badge-info">Special</div></a></li> 
            	...
            	<li> <a href="/views/admin/approval.jsp"> <i class="icon-flask"> </i>회원 가입 승인 
...
<script>
	...
	if(!("${sessionScope.member.typeNo}">=1))
